...
def gtfs2db(NETWORK_NAME, DATE_TOFILTER_ON) -> None:
    """
    Main function
    ...
    valid_routes, route = remove_unwanted_route([3], route)
    trips, valid_trips, valid_route = filter_trips_routes_ondates(valid_routes, calendar_dates, calendar, trips, DATE_TOFILTER_ON)
    #rips, valid_trips, valid_route = filter_trips_routes_ondates(route, calendar_dates, calendar, trips, DATE_TOFILTER_ON)
